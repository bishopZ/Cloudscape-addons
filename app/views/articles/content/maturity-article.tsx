...
export const MaturityArticle = () => {
  ...
  return <Container
    ...
    <SpaceBetween size="xs">
      ...
      <Header variant="h3">Step 1: Educate &mdash; igniting the spark</Header>
      <Box variant="p">
      ...
      <Header variant="h3">Step 2: Engage &mdash; building a collaborative community</Header>
      <Box variant="p">
      ...
      <Header variant="h3">Step 3: Evolve &mdash; iterating for continuous improvement</Header>
      <Box variant="p">
