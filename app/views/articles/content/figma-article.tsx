...
export const FigmaArticle = () => {
  return <Container
    ...
    <SpaceBetween size="xs">
      ...
      <Box variant="h3">Real-time collaboration</Box>
      <Box variant="p">
      ...
      <Box variant="h3">Shared design components and libraries</Box>
      <Box variant="p">
