  ...
  return <ContentLayout
    ...
    <SpaceBetween size="s">
      ...
      <Container header={<Header variant="h2">Awards</Header>}>
        ...
        <p>2019 The 50, AdClub of Colorado (<Link href="/articles/aspen-give-a-flake">Aspen Give a Fl*ke X bot</Link>)</p>
      ...
      <Container header={<Header variant="h2">Art exhibitions</Header>}>
        ...
        <p>2025 Special Effects Performer (fog), Split Sygil, itchy-O, Great American Music Hall - San Francisco, CA</p>
