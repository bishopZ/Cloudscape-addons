  ...
  return <ContentLayout
    ...
    <SpaceBetween size="m">
      ...
      <Container
        ...
        <ol>
          ...
          <li>
            ...
            component. Add any features that your team specifically needs or wants.
          </li>
        </ol>
      </Container>
      <Container
        ...
        <Box variant="p">
          ...
          manager such as Github. However, for now, these components are meant to be maintained
      ...
      <Container
        ...
        <ul>
          <li>
              Our community blog updates every two weeks with new articles
